...
namespace H4G_Project.Models
{
    ...
    public class Application
    {
        ...
        [FirestoreProperty]
        [Display(Name = "Family Member Full Name")]
        [StringLength(50, ErrorMessage = "Name cannot exceed 50 characters")]
        [Required(ErrorMessage = "Please input family member name!")]
        ...
        [Required(ErrorMessage = "Please select disability type!")]
        ...
        [FirestoreProperty]
        public string MedicalReportUrl { get; set; } = string.Empty;
